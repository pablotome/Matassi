...
{
	public class ConsultaOfertaEmision
	{
		[RegularExpression("\\d{1,4}", ErrorMessage = "El campo tiene que ser numérico de hasta 4 dígitos")]
		public int Grupo { get; set; }

		[RegularExpression("\\d{1,3}", ErrorMessage = "El campo tiene que ser numérico de hasta 3 dígitos")]
